...
def get_latest_pollution(userid, password):
    ...
    for city in allcities_list:
        ...
        maxdatestr = max([results[1] for results in allresults]).strftime("%m/%d/%Y")
    ...
    no2_table_html = "<b>NO2 data</b><table><tr><th>City</th><th>01/01/2020</th><th>02/01/2020</th><th>" + maxdatestr + "</th><th>% Change</th></tr>"
